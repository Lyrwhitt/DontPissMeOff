...
{
    // Resources °æ·Î string (temp)
    [field: SerializeField] public float PlayerChasingRange { get; private set; } = 10f;
    [field: SerializeField] public float ReturnDistance { get; private set; } = 10f;
    ...
    [field: SerializeField] public EnemyAttackData AttakData { get; private set; }
}
